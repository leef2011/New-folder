...
var themes = {
  'default' : {main: 'F2F2F2', primary: 'CCCCCC', secondary: '111111', text: '000000', link: '0000EE', visited: '551A8B', prop : true},
  'dark'    : {main: '404040', primary: '666666', secondary: 'FFFFFF', text: 'FFFFFF', link: 'FFFFFF', visited: 'B3B3B3', prop : true},
  'darker'  : {main: '000000', primary: '262626', secondary: 'FFFFFF', text: 'FFFFFF', link: 'FFFFFF', visited: 'B3B3B3', prop : true},
...
function _build (keys, log_keys, timeis) {
  ...
  for (var i = 0; i < keys.length; i++) {
    var hit = hitlog[keys[i]], blocked = _check_block(hit), included = _check_include(hit), classes = _color_to(hit), remove = false;
    ...
    hit_html +=
      ...
      '<button data-term="' + hit.title + '" data-name="' + hit.title + '" class="rt">T</button>' +
      ...
      '<span style="width: 60px; display:inline-block; text-align: center;">' +
      '<button style="width: 20px; height: 20px; color: #000000; background-color: ' + hit.rcolor + '; margin: 1px;  border: 1px solid; font-size: 80%; padding: 1px;">R</button>' +
      '<button style="width: 20px; height: 20px; color: #000000; background-color: ' + hit.tcolor + '; margin: 1px;  border: 1px solid; font-size: 80%; padding: 1px;">T</button>' +
      '</span>' +
  ...
  if (log_keys.length) {
    for (var j = 0; j < log_keys.length; j ++) {
      var hit_log = hitlog[log_keys[j]], included_log = _check_include(hit_log), classes_log  = _color_to(hit_log);
      ...
      log_html +=
        ...
        '<button data-term="' + hit_log.title + '" data-name="' + hit_log.title + '" class="rt">T</button>' +
        ...
        '<span style="width: 60px; display:inline-block; text-align: center;">' +
        '<button style="width: 20px; height: 20px; color: #000000; background-color: ' + hit_log.rcolor + '; margin: 1px;  border: 1px solid; font-size: 80%; padding: 1px;">R</button>' +
        '<button style="width: 20px; height: 20px; color: #000000; background-color: ' + hit_log.tcolor + '; margin: 1px;  border: 1px solid; font-size: 80%; padding: 1px;">T</button>' +
        '</span>' +

        '</div>' +
        '</div>'+

        '<div class="info ' + _color_to(hit_log) + '" value="' + hit_log.key + '" style="overflow: hidden; display: none; font-size: 11px;">' +
  ...
  switch (config.to_theme) {
    ...
    case '2':
      to =
        ...
        '.rt       {width: 20px; height: 20px; color: #'+theme.text+'; background-color: transparent; margin: 1px;  border: 1px solid  #'+theme.text+'; font-size: 80%; padding: 1px;}' +
